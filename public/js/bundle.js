...
var displayMap = function displayMap(loc) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // reload from server, not the cache
...
console.log(logOutBtn); // DELEGATION

if (mapBox) {
  var loc = JSON.parse(mapBox.dataset.location); // lng first lat second

  var location = [loc.coordinates[1], loc.coordinates[0]];
